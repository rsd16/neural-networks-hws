...
cm1 = confusion_matrix(y_test, predictions, labels=[1.0, -1.0])
df_cm1 = pd.DataFrame(cm1, index=[1.0, -1.0], columns=[1.0, -1.0])
...
accuracy = model.score(y_test, predictions)
cm2 = confusion_matrix(y_test, predictions, labels=[1.0, -1.0])
df_cm2 = pd.DataFrame(cm2, index=[1.0, -1.0], columns=[1.0, -1.0])
...
accuracy = model.score(y_test, predictions)
cm3 = confusion_matrix(y_test, predictions, labels=[1.0, -1.0])
df_cm3 = pd.DataFrame(cm3, index=[1.0, -1.0], columns=[1.0, -1.0])
...
accuracy = model.score(y_test, predictions)
cm4 = confusion_matrix(y_test, predictions, labels=[1.0, -1.0])
df_cm4 = pd.DataFrame(cm4, index=[1.0, -1.0], columns=[1.0, -1.0])
